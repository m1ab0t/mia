...
import { parseRecapArgs, loadTracesForDate, buildRecap, type RecapData } from './recap.js';
...
describe('parseRecapArgs', () => {
  ...
  it('last --yesterday / --date wins', () => {
    ...
    expect(result).toEqual({ date: '2026-01-05', json: false });
  });
